...
export const quotes: QuoteDBModel[] = [
    {
        ...
        content: `
            **There are two parts to learning craftsmanship: knowledge and work.**
            You must gain the knowledge of principles, patterns,
            practices, and heuristics that a craftsman knows, and you
            must also grind that knowledge into your fingers, eyes, and
            ...
            **I can teach you the physics of riding a bicycle.**
            ...
            knowledge you needed to make it work. **And you’d still fall 
            down the first time you climbed on that bike.**
            
            **Coding is no different.** We could write down
            ...
            Learning to write clean code is *hard work*. It
            requires more than just the knowledge of principles and
            patterns. You must *sweat* over it. You must practice
    ...
    },
    {
        ...
        content: `
            ...
            manage it any longer. **_It was the bad code that brought the
            company down_**.

            If you have experienced even one small part of the story I
            just told, then you already know that **spending time keeping
    ...
    },
    {
        ...
        content: `
            ...
            and useless marketing types and telephone sanitizers. **But the
    ...
    },
    {
        ...
        content: `
            ...
            short, **they don’t take the time to go fast!**
            ...
            will force you to miss the deadline. **The _only_ way to make
    ...
    },
    {
        ...
        content: `
            ...
            mean that we know how to paint. **So too being able to recognize 
    ...
    },
    {
        ...
        page: "8",
        content: `
            [...] **clean code does one thing well**. It is no
            ...
            **Bad code tries to do too much**, it has muddled
            intent and ambiguity of purpose. Clean code is _focused_.
    ...
    },
    {
        ...
        content: `
            ...
            right. **Code, without tests, is not clean.** No matter how 
    ...
    },
    {
        ...
        page: "11",
        content: `
            **"_You know you are working on clean code when each routine
            you read turns out to be pretty much what you expected._"**
    ...
    },
    {
        ...
        page: "12",
        content: `
            **Programs that are _that_ clean are so profoundly well written 
            that you don’t even notice it. The designer makes it look 
            ridiculously simple like all exceptional designs.**
        `,
        tags: [quoteTags.Clarity, quoteTags.Inspiring],
        rating: 3
    },
    {
        ...
        content: `
            ...
            says that beautiful code _makes the language look like it was 
            made for the problem_! So it’s our responsibility to make the 
            language look simple! Language bigots everywhere, beware! It is 
            not the language that makes programs appear simple. **It is the 
            programmer that make the language appear simple!**
        `,
        tags: [quoteTags.Clarity, quoteTags.Inspiring],
        rating: 2
    },
    {
        ...
        content: `
            ...
            over 10:1. We are _constantly_ reading old code as part
            ...
            there’s no way to write code without reading it, so _making 
            it easy to read actually makes it easier to write_.
            ...
            quickly, **if you want your code to be easy to write, make 
            it easy to read.**
        `,
    ...
    },
    {
        ...
        content: `
            ...
            does, and how it is used. **If a name requires a comment, then
    ...
    },
    {
        ...
        content: `
            ...
            **The problem isn’t the simplicity of the code but the implicity
            of the code** (to coin a phrase): the degree to which the context
    ...
    },
    {
        ...
        content: `
            ...
            _clarity is king_. Professionals use their powers for good
    ...
    },
    {
        ...
        content: `
            ...
            **The first rule of functions is that they should be small.
            ...
            than that.** This is not an assertion that I can justify. 
            ...
            should not be 100 lines long. **Functions should hardly ever 
            be 20 lines long.**
            ...
            programs that took up miles of vertical space. **Every function 
            in this program was just two, or three, or four lines long.**
    ...
    },
    {
        ...
        content: `
            ...
            or not. **That choice has become (and always should be) an
            ...
            **This interface is also tailored and constrained to meet
            the needs of the application.** It results in code that is 
    ...
    },
    {
        ...
        content: `
            ...
            return on investment. **When there are new releases of the 
            ...
            production code does. **Without these boundary tests to ease 
    ...
    },
    {
        ...
        content: `
            ...
            The moral of the story is simple: **_Test code is just as 
            important as production code_**. It is not a second-class 
    ...
    },
    {
        ...
        page: "124",
        content: `
            It is _unit tests_ that keep our code flexible,
            ...
            **If you have tests, you do not fear making changes 
            ...
            the dirtier your code becomes. **Eventually you lose the tests, 
            and your code rots.**
        `,
        tags: [
            quoteTags.Inspiring,
