...
export const quotes: QuoteDBModel[] = [
    ...
    },
    {
        ...
        content: `
            <p>
                ...
                seriously, <strong>they reflect an unvoiced assumption which 
                is quite untrue, i.e., that all will go well</strong>.
            </p>
        `,
    ...
    },
    {
        ...
        content: `
            ...
            <p>
                ...
                number of months. <strong>Progress does not</strong>. <i>Hence 
                the man-month as a unit for measuring the size of a job is a 
                dangerous and deceptive myth.</i> It implies that men and months 
                are interchangeable.
            </p>
            <p>
                Men and months are interchangeable commodities only when a task 
                can be partitioned among many workers <i>with no communication 
                among them</i>. This is true of reaping wheat or picking cotton; 
                it is not even approximately true of systems programming.
            </p>
    ...
    },
    {
        ...
        content: `
            ...
            <ol>
                <li value="3">
                    <strong>The part that is easy to estimate, i.e., coding, is
                    given only one-sixth of the schedule.</strong>
                </li>
            </ol>
        `,
        tags: [quoteTags.Estimation],
    ...
    },
    {
        ...
        content: `
            ...
            <p>
                <strong>The cook has another choice; he can turn up the heat. 
                The result is often an omelette nothing can save—burned in one 
                part, raw in another.</strong>
            </p>
        `,
    ...
    },
    {
        ...
        content: `
            <p>
                ...
                actual measured magnitudes have astounded all of us. In one
                of their studies, Sackman, Erikson, and Grant were measuring
                performances of a group of experienced programmers. Within
                just this group the ratios between best and worst performances 
            ...
            <p>
                ...
                coordinated affects the cost of the effort, for a major part
                of the cost is communication and correcting the ill effects
                of miscommunication (system debugging). This, too, suggests
                that one wants the system to be built by as few minds as
                possible. [...]
            </p>
            <p>
                The conclusion is simple: if a 200-man project has 25 managers 
                who are the most competent and experienced programmers, 
                <strong>fire the 175 troops and put the managers back to 
                programming.</strong>
            </p>
        `,
    ...
    },
    {
        ...
        content: `
            ...
            <p>
                No software organization can ignore this challenge. <strong>Good 
                managers, scarce though they be, are no scarcer than good 
                designers.</strong> Great designers and great managers are both 
                very rare. Most organizations spend considerable effort in 
                finding and cultivating the management prospects; I know of none 
                that spends equal effort in finding and developing the great 
                designers upon whom the technical excellence of the products 
                will ultimately depend.
            </p>
            <p>
                <strong>My first proposal is that each software organization 
                must determine and proclaim that great designers are as 
                important to its success as great managers are</strong>, and 
                that they can be expected to be similarly nurtured and rewarded. 
                Not only salary, but the perquisites of recognition—office size, 
    ...
    },
    {
        ...
        content: `
            <p>
                ...
                Lister's 1987 book, <i>Peopleware: Productive Projects and 
                Teams</i>. Its underlying thesis is that <q>The major problems 
                of our work are not so much <i>technological</i> as 
                <i>sociological</i> in nature.</q> It abounds with gems such as,
                <strong><q>The manager's function is not to make people work, it 
                is to make it possible for people to work.</q></strong>
            </p>
        `,
        tags: [quoteTags.Team],
        rating: Rating.Good
